...
4.  **Handle I/O (Pragmatic Extension):** Pure interaction nets don't have built-in I/O. The easiest way is to introduce special "magic" agents (e.g., `ReadConsole`, `WriteConsole`) that interact with the outside world. These agents break the pure model slightly but are necessary for practical programming. Their interaction rules would trigger system calls or other side effects.
...
15. **Develop Example Programs**
    ...
    * [ ] Build larger case studies showing real-world applications
...
25. **Practical Applications**
    ...
    * [ ] Create example real-world applications showcasing language capabilities
